...
To contribute to docker-kali-linux project on [GitHub](https://github.com/hadenlabs/docker-kali-linux), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/docker-kali-linux/pulls).
...
```bash
git remote add upstream  https://github.com/hadenlabs/docker-kali-linux.git
```

Now your **upstream** points to **hadenlabs/docker-kali-linux**.
...
git fetch upstream # assuming upstream is hadenlabs/docker-kali-linux
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/docker-kali-linux/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
