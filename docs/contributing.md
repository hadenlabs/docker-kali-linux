...
- Contribute to docker-kali-linux repositories on [GitHub](https://github.com/hadenlabs/docker-kali-linux). See [Git flow](./contribute/git-flow.md).
...
Documentation is a part of the docker-kali-linux code base. You can find the documentation files in the `doc/` subdirectory of the [main repository](https://github.com/hadenlabs/docker-kali-linux). This means that the contribution process is the same for both the source code and documentation.
